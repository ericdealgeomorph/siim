...
docs-build time, to keep the build fast; they run anywhere siim is installed.
...
no-op here and the bed evolves as in plain mode B (the mode-C routing helpers
stay active; see {doc}`../guides/concepts`). To resolve the carving (trough
